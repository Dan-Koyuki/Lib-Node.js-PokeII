...
exports.TM = [
    ...
    },
    {
        ...
        name: "TM051",
        moves: "Sandstorm",
        description: "Teaches Sandstorm to compatible Pokemon.",
        price: 3000,
        recipe: [
            "Hippopotas Sand x3",
            "Silicobra Sand x3",
    ...
    },
    {
        ...
        name: "TM058",
        moves: "Brick Break",
        description: "Teaches Brick Break to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Makuhita Sweat x3",
            "Hawlucha Down x3",
    ...
    },
    {
        ...
        name: "TM077",
        moves: "Waterfall",
        description: "Teaches Waterfall to compatible Pokemon.",
        price: 8000,
        recipe: [
            "Magikarp Scales x5",
            "Basculin Fang x3",
    ...
    },
    {
        ...
        name: "TM097",
        moves: "Fly",
        description: "Teaches Fly to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Squawkabilly Feather x3",
    ...
    },
    {
        ...
        name: "TM099",
        moves: "Iron Head",
        description: "Teaches Iron Head to compatible Pokemon.",
        price: 8000,
        recipe: [
            "Cufant Tarnish x5",
            "Pawniard Blade x3",
    ...
    },
    {
        ...
        name: "TM105",
        moves: "X-Scissor",
        description: "Teaches X-Scissor to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Fomantis Leaf x3",
    ...
    },
    {
        ...
        name: "TM113",
        moves: "Tailwind",
        description: "Teaches Tailwind to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Rufflet Feather x3",
            "Rookidee Feather x3",
    ...
    },
    {
        ...
        name: "TM121",
        moves: "Heavy Slam",
        description: "Teaches Heavy Slam to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Cufant Tarnish x3",
            "Bronzor Fragment x3",
    ...
    },
    {
        ...
        name: "TM140",
        moves: "Nasty Plot",
        description: "Teaches Nasty Plot to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Meowth Fur x3",
    ...
    },
    {
        ...
        name: "TM145",
        moves: "Water Pledge",
        description: "Teaches Water Pledge to compatible Pokemon.",
        price: 8000,
        recipe: [
            "Luvdisc Scales x3",
            "Alomomola Mucus x3",
    ...
    },
    {
        ...
        name: "TM154",
        moves: "Hydro Cannon",
        description: "Teaches Hydro Cannon to compatible Pokemon.",
        price: 14000,
        recipe: [
            "Qwilfish Spines x8",
            "Dondozo Whisker x5",
    ...
    },
    {
        ...
        name: "TM160",
        moves: "Hurricane",
        description: "Teaches Hurricane to compatible Pokemon.",
        price: 12000,
        recipe: [
            "Swablu Fluff x5",
            "Oricorio Feather x3",
    ...
    },
    {
        ...
        name: "TM161",
        moves: "Trick Room",
        description: "Teaches Trick Room to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Hatenna Dust x3",
            "Bronzor Fragment x3",
    ...
    },
    {
        ...
        name: "TM164",
        moves: "Brave Bird",
        description: "Teaches Brave Bird to compatible Pokemon.",
        price: 12000,
        recipe: [
            "Starly Feather x5",
            "Rufflet Feather x3",
    ...
    },
    {
        ...
        name: "TM165",
        moves: "Flare Blitz",
        description: "Teaches Flare Blitz to compatible Pokemon.",
        price: 12000,
        recipe: [
            "Growlithe Fur x5",
    ...
    },
    {
        ...
        name: "TM170",
        moves: "Steel Beam",
        description: "Teaches Steel Beam to compatible Pokemon.",
        price: 14000,
        recipe: [
            "Magnemite Screw x8",
            "Orthworm Tarnish x5",
    ...
    },
    {
        ...
        name: "TM199",
        moves: "Lash Out",
        description: "Teaches Lash Out to compatible Pokemon.",
        price: 5000,
        recipe: [
            "Vullaby Feather x3",
            "Pawniard Blade x2",
    ...
    },
    {
        ...
        description: "Teaches Breaking Swipe to compatible Pokemon.",
        price: 3000,
        recipe: [
            "Duraludon Tarnish x3",
            "Axew Scales x2",
            "Cyclizar Scales x1",
        ],
        category: helper_enum_1.BagCategory.MACHINES,
    ...
    },
    {
        ...
        name: "TM226",
        moves: "Dragon Cheer",
        description: "Teaches Dragon Cheer to compatible Pokemon.",
        price: 1500,
        recipe: [
            "Tatsugiri Scales x2",
            "Lapras Teardrop x2",
